...
### Schritt 1: Selbst [!DNL Marketo Engage] werden

Als Administrator sollten Sie sich zunächst in [!DNL Marketo Engage] Ressourcen wie die Marketing Nation-Community und die Dokumentation eintauchen. Lesen und erkunden Sie diese Materialien während der Evaluierungs- und Implementierungsphase regelmäßig, um Ihr Fachwissen zu erweitern.

### Schritt 2: Entwicklung von Strategien für die Teamschulung

* Berücksichtigen Sie bei der Schulung Ihres Marketing-Teams die Staffelung der Teilnahme an den Kursen zu den Kernkonzepten 1 und 2. Stellen Sie sicher, dass die Team-Mitglieder verschiedene Kurse mit verschiedenen Kursleitern besuchen, um verschiedene Perspektiven und Einblicke zu erhalten, die mit der Gruppe geteilt werden können.
* Nutzen Sie die Tutorials von Adobe Experience League, die Ihrem Team kurze, leicht zu verdauende Lektionen bieten, um in ihrem eigenen Tempo mit der [!DNL Marketo Engage] zu beginnen.
* Motivieren Sie Teammitglieder dazu, während wöchentlicher Teamanrufe neu erworbenes Wissen auszutauschen. Dadurch wird sichergestellt, dass wertvolle Einblicke über Ihr Team verteilt werden, das die Instanz effektiv verwaltet.
...
| Konversationsautomatisierung + Integration der Chatbot-Lösung | <ul><li>Aktivieren von Chat als neuen Marketing-Kanal</li><li>Dynamic Chat - Installieren eines Chat-Bot-Snippets, Erstellen und Veröffentlichen automatisierter Dialogfelder</li></ul> | Aufgezeichnetes Video zum Erstellen von Dialogen und Entwickeln von Zielgruppenkriterien, Überprüfung von Stream Designer | 1h |
| Marketo Sales Insight | <ul><li>Senden und Nachverfolgen von E-Mails aus Marketo Sales Insight</li><li>MSI Outlook-Plug-in</li></ul> | Aufgezeichnetes Video des End-to-End-Prozesses zur einfachen Verteilung an neue Mitarbeiter | 1h |
| Reporting und Analysen | <ul><li>Anleitung zur Berichterstellung</li><li>E-Mail, Landingpage und Programmleistung</li><li>Erstellen eigener Berichte</li><li>E-Mail- und Leistungseinblicke</li></ul> | Laufende Schulungen, aufgezeichnete Videos zu wichtigen Sitzungen, regelmäßige Reviews | 2 Std |
| Content-KI | <ul><li>Überprüfen der Funktionen der Content-KI</li><li>Überprüfen von Assets, die für Content-KI infrage kommen (d. h. Landingpage, E-Mail und Dialogfeld)</li><li>Zu verwendender Map-out-Prozess (wann/wo)</li></ul> | Live-Sitzung, exemplarische Vorgehensweise und Funktionsweise | 1h |
